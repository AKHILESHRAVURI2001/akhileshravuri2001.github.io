    ...
    <section id="skills" className="py-14 sm:py-16 relative z-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-purple-950/70 border border-purple-500/30 text-xs font-mono text-purple-300 mb-3">
        ...
        <div className="flex items-center justify-center gap-2 sm:gap-3 flex-wrap mb-10">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 sm:px-4 sm:py-2.5 rounded-xl text-xs sm:text-sm font-mono transition-all cursor-pointer ${
              activeTab === 'all'
          ...
          {skills.categories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-xl text-xs sm:text-sm font-mono transition-all cursor-pointer ${
                  isActive
          ...
          {skills.categories
            ...
            .map((cat) => (
              ...
              >
                ...
                {/* Clean Professional Technology Badges */}
                <div className="flex flex-wrap gap-2.5 sm:gap-3">
                  {cat.items.map((item, idx) => (
                    <div
                      key={idx}
                      className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-quantum-surface/80 border border-cyan-500/20 hover:border-cyan-400 hover:bg-cyan-500/10 hover:shadow-[0_0_15px_rgba(0,245,255,0.2)] transition-all cursor-default group"
                    >
                      <CheckCircle2 className="w-4 h-4 text-higgs-cyan flex-shrink-0 group-hover:scale-110 transition-transform" />
